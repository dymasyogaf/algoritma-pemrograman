...
public class Tugas1 {
    ...
    static long gajiPokok(char golongan) {
        switch (Character.toUpperCase(golongan)) {
            case 'A': return 5_000_000L;
            case 'B': return 6_500_000L;
            case 'C': return 9_500_000L;
            default:  return -1L; // penanda tidak valid
        }
    }

    // Tentukan presentase lembur berdasarkan jam lembur
    static double persenLembur(int jam) {
        if (jam < 0) return -1; // tidak valid
        switch (jam) {
            case 0: return 0.00;
            case 1: return 0.30;
            case 2: return 0.32;
    ...
    static long hitungTotal(char golongan, int jamLembur) {
        ...
        long gajiLembur = Math.round(p * pokok); // dibulatkan ke rupiah terdekat
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Input jam lembur harus berupa angka bulat.");
